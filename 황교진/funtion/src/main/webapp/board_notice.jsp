...
<body>
			...
			<div id="logo">
				...
				<p>
					<span class="name multiple">스마트타임</span><span class="subname"
						onclick="location.href='main.jsp'">스마트인재개발원</span>
				</p>
			</div>
			<!-- Nav 상단바 -->
			<div id="cate">
				<ul>
					<li class="menu"><a href="notice.jsp">공지사항</a>
						<ul class="sub1">
							<li><a href="notice.jsp">공지사항</a></li>
							<li><a href="contest.jsp">공모전</a></li>
						</ul></li>
					<li class="menu"><a href="free.jsp">게시판</a>
						<ul class="sub2">
					...
					<li class="menu"><a href="download.jsp">자료실</a>
						<ul class="sub3">
							<li><a href="download.jsp">자료실</a></li>
							<li><a href="source.jsp">공용소스</a></li>
						</ul></li>
					<li class="menu"><a href="timetable.jsp">시간표</a></li>
					<li class="menu"><a href="fan.jsp">팬게시판</a></li>
				</ul>
			</div>
			<!-- 스인재웹, 내정보 상단아이콘 -->
			<div id="account">
				<a href="https://smhrd.or.kr" title="스인재" class="icon web">스인재</a> <a
					href="my.jsp" title="내 정보" class="icon my">내 정보</a>
			</div>
		</div>
	</nav>
	<!-- 공지사항 게시글작성 -->
	<div id="container" class="article">
		...
		<div class="wrap articles">
			...
			<article>
				<a class="article"> <img src="image/사용자정보.png"
					class="picture large">
					<div class="profile">
						<h3 class="large">교징어</h3>
						<time class="large">05/16 17:57</time>
					</div> <c:forEach var="a" items="${bdList}" varStatus="status">
						<ul class="status">
							<button type="submit">
							...
							<button type="submit">
								<li class="delete"><a
									href="deleteboardCon?boardseq=${a.article_seq}">삭제</a></li>
							</button>
			...
			<div class="pagination">
				<a id="goListButton" class="list" href="notice.jsp">글 목록</a><br>
				<br>
				<br>
			</div>
		</div>
		...
		<div class="rightside">
			...
			<div class="card">
				<div class="board">
					<h3>
						<a href="best.jsp">BEST게시판 <span>더보기</span>
						</a>
					</h3>
					<a href="best.jsp" class="list"> <time>05/12 12:50</time>
