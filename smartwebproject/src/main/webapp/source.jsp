...
<body>
    ...
    <div id="container" class="article">
            <%
              Board b_vo = (Board)session.getAttribute("selectSource");
              BoardDAO dao = new BoardDAO();
              List<Board> bdList = dao.selectSource();
        ...
        <c:if test="${empty bdList }">
          ...
          <c:if test="${bdList != null }">  
           ...
           <article>
                <a class="article" href="source.jsp">
	...
	<script src="assets/js/sourcewrite.js"></script>
