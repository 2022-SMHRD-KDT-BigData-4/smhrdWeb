...
$("#writeArticleButton").on("click", function () {
        ...
        writeArticleButton += "<select id='seq2' name='article_type'><option value='공지사항' selected/></select>" 
        ...
        writeArticleButton += `<li title='목록' class='list' onclick='location.href="boardwrite.jsp"'></li>`
...
$("#writeArticleButton").on("click", function () {
        ...
        writeArticleButton += '</p>'
        writeArticleButton += '<p>'
        writeArticleButton += '<textarea name="text"  class="smallplaceholder" placeholder="스마트타임은 스마트인재개발원 학생들의 원할한 커뮤니케이션을 위한 커뮤니티입니다. 맘편히 사용해주세요. \n\n※ 공지사항 이용안내\n- 공지사항의 글쓰기,수정,삭제 등 기능은 괸리자만 가능합니다."></textarea>'
        writeArticleButton += '</p>'
        writeArticleButton += '<input class="file" type="file" name="file" multiple="multiple">'
        writeArticleButton += '<ol class="thumbnails">'
        writeArticleButton += '<li class="new">'
