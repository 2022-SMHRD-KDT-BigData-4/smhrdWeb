...
$("#writeArticleButton").on("click", function () {
        writeArticleButton += "<form action='DownloadCon' method='post' class='write'>"
        ...
        writeArticleButton += "<select id='seq2' name='article_type'><option value='자료실' selected/></select>" 
        ...
        writeArticleButton += `<li title='목록' class='list' onclick='location.href="download.jsp"'></li>`
