...
$("#writeArticleButton").on("click", function () {
        writeArticleButton += "<form action='JungHyungWriteCon' method='post' class='write'>"
        ...
        writeArticleButton += "<select id='seq2' name='article_type'><option value='형쌤게시판' selected/></select>" 
        ...
        writeArticleButton += `<li title='목록' class='list' onclick='location.href="junghyung.jsp"'></li>`
