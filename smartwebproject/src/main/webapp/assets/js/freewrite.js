...
$("#writeArticleButton").on("click", function () {
        writeArticleButton += "<form action='FreeWriteCon' method='post' class='write'>"
        ...
        writeArticleButton += "<select id='seq2' name='article_type'><option value='자유게시판' selected/></select>" 
        ...
        writeArticleButton += `<li title='목록' class='list' onclick='location.href="free.jsp"'></li>`
