...
$("#writeArticleButton").on("click", function () {
        writeArticleButton += "<form action='InformationWriteCon' method='post' class='write'>"
        ...
        writeArticleButton += "<select id='seq2' name='article_type'><option value='정보게시판' selected/></select>" 
        ...
        writeArticleButton += `<li title='목록' class='list' onclick='location.href="information.jsp"'></li>`
