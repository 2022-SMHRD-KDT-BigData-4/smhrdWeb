...
$("#writeArticleButton").on("click", function () {
        writeArticleButton += "<form action='SourceWriteCon' method='post' class='write'>"
        ...
        writeArticleButton += "<select id='seq2' name='article_type'><option value='공용소스' selected/></select>" 
        ...
        writeArticleButton += `<li title='목록' class='list' onclick='location.href="source.jsp"'></li>`
