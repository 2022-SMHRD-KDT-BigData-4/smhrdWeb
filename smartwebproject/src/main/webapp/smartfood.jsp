...
<body>
	...
	<nav>
		<div class="wrap">
			<!-- 로고이미지,스마트타임 -->
			<div id="logo">
				<a href="main.jsp" class="mainimg"><img
					src="image/시계.png"></a>
				<p>
			...
			<div id="cate">
				<ul>
					...
					<li class="menu"><a
						href="timetable.jsp">시간표</a></li>
					<li class="menu"><a href="fan.jsp">팬게시판</a>
					</li>
				</ul>
			</div>
			<!-- 스인재웹, 내정보 상단아이콘 -->
		...
		<div class="rightside">
			...
			<div class="card">
				<div class="board">
					...
					<a href="best.jsp" class="list"> <time>05/12
