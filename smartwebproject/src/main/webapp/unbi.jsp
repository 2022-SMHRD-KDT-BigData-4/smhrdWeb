...
<body>
    ...
    <div id="container" class="article">
            <%
              Board b_vo = (Board)session.getAttribute("selectUnbi");
              BoardDAO dao = new BoardDAO();
              List<Board> bdList = dao.selectUnbi();
        ...
        <c:if test="${empty bdList }">
          ...
          <c:if test="${bdList != null }">  
           ...
           <article>
                <a class="article" href="board_unbi.jsp">
	...
	<script src="assets/js/unbiwrite.js"></script>
