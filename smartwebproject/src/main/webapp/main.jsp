...
<body>
    <nav>
        <div class="wrap">
            <!-- 로고이미지,스마트타임 -->
            <div id="logo">
                <a href="/html,css,js/html/메인/main.html" class="mainimg"><img src="image/시계.png"></a>
            ...
            <div id="container" class="community">
                <div class="leftside">
                    <div class="card pconly">
                        <form class="logged">
                            <img src="/이미지/사용자정보.png" class="picture">
                            <p class="nickname">교징어</p>
                            <p class="school">황교진</p>
                            <p class="school">rywls18</p>
                            <ul class="buttons">
                                <li><a href="/html,css,js/html/왼쪽사이드바/my.html">내 정보</a></li>
                                <li><a href="/html,css,js/html/로그인/Login.html">로그아웃</a></li>
                            </ul>
                            <hr>
                        </form>
                    </div>
                    <div class="card">
                        <div class="menus">
                            <a href="/html,css,js/html/왼쪽사이드바/mywrite.html" class="myarticle">내가 쓴 글</a>
                            <a href="/html,css,js/html/왼쪽사이드바/mycomment.html" class="mycommentarticle">댓글 단 글</a>
                            <a href="/html,css,js/html/왼쪽사이드바/myscrap.html" class="myscrap">내 스크랩</a>
                            <hr>
                        </div>
                    </div>
                </div>
                ...
                <div class="main">
                    <div class="card">
                        <div class="board">
                            <h3><a href="/html,css,js/html/게시판/notice.html">공지사항</a></h3>
                            <a href="#" class="list">
                                <time>4분 전</time>
                                스마트인재개발원 상금
                                <hr>
                ...
                <div class="rightside">
                    ...
                    <div class="card">
                        <div class="board">
                            ...
                            <a href="/html,css,js/html/게시판/board_notice.html" class="list">
