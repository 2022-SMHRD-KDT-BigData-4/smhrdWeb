...
<body>
    ...
    <div id="container" class="article">
            <%
              Board b_vo = (Board)session.getAttribute("selectJungHyung");
              BoardDAO dao = new BoardDAO();
              List<Board> bdList = dao.selectJungHyung();
        ...
        <div class="wrap articles">
          ...
          <c:if test="${bdList != null }">  
           ...
           <article>
                <a class="article" href="junghyung.jsp">
	...
	<script src="assets/js/junghyungwrite.js"></script>
