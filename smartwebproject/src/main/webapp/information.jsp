...
<head>
    ...
    <div id="container" class="article">
            <%
              Board b_vo = (Board)session.getAttribute("selectInformation");
              BoardDAO dao = new BoardDAO();
              List<Board> bdList = dao.selectInformation();
        ...
        <div class="wrap title">
            <h1>
                <a href="information.jsp">정보게시판</a>
            </h1>
            <hr>
        </div>
        <div class="wrap articles">
          ...
          <c:if test="${bdList != null }">  
           ...
           <article>
                <a class="article" href="information.jsp">
	...
	<script src="assets/js/informationwrite.js"></script>
