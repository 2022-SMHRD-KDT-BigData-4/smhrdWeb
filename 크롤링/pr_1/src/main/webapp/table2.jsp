...
<body>
    ...
    <nav>
        <div class="wrap">
            <!-- 로고이미지,스마트타임 -->
            <div id="logo">
                <a href="/html,css,js/html/메인/main.html" class="mainimg"><img src="images/시계.png"></a>
        ...
        <div class="wrap articles">
            ...
            <article>
                <a class="article" href="/html,css,js/html/게시판/board_contest.html">
                    <img src='${b.cro_img}' class='contest'>
                    <h2 class="medium">'${b.cro_title}'</h2>
                    <p class="small">'${b.cro_field}'</p>
                    <time class="small">'${b.cro_date}'</time>
